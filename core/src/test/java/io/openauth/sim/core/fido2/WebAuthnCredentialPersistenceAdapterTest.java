...
class WebAuthnCredentialPersistenceAdapterTest {
    ...
    void serializeProducesSchemaAlignedRecord() {
        ...
        assertEquals(VersionedCredentialRecord.CURRENT_VERSION, record.schemaVersion(), "schema version");
    ...
    void deserializeRebuildsDescriptor() {
        ...
        VersionedCredentialRecord mappedRecord =
                VersionedCredentialRecordMapper.toRecord(VersionedCredentialRecordMapper.toCredential(record));
    ...
    void deserializeRejectsNonFido2Type() {
        ...
        VersionedCredentialRecord invalidRecord = new VersionedCredentialRecord(
