...
class TotpGeneratorTest {
    ...
    private static final List<TotpJsonVector> SHA1_SEQUENCE = TotpJsonVectorFixtures.loadAll()
            .filter(vector ->
                    vector.algorithm() == TotpHashAlgorithm.SHA1 && vector.digits() == 8 && vector.stepSeconds() == 30)
    ...
    void generatesRfc6238Sha1Sequence() {
        TotpDescriptor descriptor = TotpDescriptor.create(
                "token-rfc-sha1", SHA1_T59.secret(), TotpHashAlgorithm.SHA1, 8, SHA1_T59.stepDuration());
        List<String> expectedOtps = List.of("94287082", "07081804", "14050471", "89005924", "69279037", "65353130");
    ...
    void supportsSha256AndSha512Vectors() {
        TotpDescriptor sha256Descriptor = TotpDescriptor.create(
                "token-rfc-sha256", SHA256_T59.secret(), TotpHashAlgorithm.SHA256, 8, SHA256_T59.stepDuration());
        TotpDescriptor sha512Descriptor = TotpDescriptor.create(
                "token-rfc-sha512", SHA512_T59.secret(), TotpHashAlgorithm.SHA512, 8, SHA512_T59.stepDuration());
    ...
    void remainsStableWithinSameTimeStep() {
        TotpDescriptor descriptor = TotpDescriptor.create(
                "token-stable", SHA1_T1234567890.secret(), TotpHashAlgorithm.SHA1, 8, SHA1_T1234567890.stepDuration());
    ...
    void rejectsSecretsBelowMinimumLength() {
        ...
        assertThrows(
                IllegalArgumentException.class, () -> TotpGenerator.generate(descriptor, Instant.ofEpochSecond(59)));
    }
