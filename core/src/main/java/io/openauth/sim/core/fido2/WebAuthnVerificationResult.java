...
public record WebAuthnVerificationResult(boolean success, Optional<WebAuthnVerificationError> error, String message) {

    public static WebAuthnVerificationResult successResult() {
        return new WebAuthnVerificationResult(true, Optional.empty(), "OK");
    }

    public static WebAuthnVerificationResult failure(WebAuthnVerificationError error, String message) {
