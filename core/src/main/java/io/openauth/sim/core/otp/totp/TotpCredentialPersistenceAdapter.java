...
public final class TotpCredentialPersistenceAdapter
    implements CredentialPersistenceAdapter<TotpDescriptor> {
  ...
  public VersionedCredentialRecord serialize(TotpDescriptor descriptor) {
    ...
    attributes.put(ATTR_DRIFT_BACKWARD, Integer.toString(descriptor.driftWindow().backwardSteps()));
    attributes.put(ATTR_DRIFT_FORWARD, Integer.toString(descriptor.driftWindow().forwardSteps()));
