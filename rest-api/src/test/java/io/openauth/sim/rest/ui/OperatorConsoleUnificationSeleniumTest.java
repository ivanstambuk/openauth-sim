...
final class OperatorConsoleUnificationSeleniumTest {
    ...
    void unifiedConsoleRendersProtocolTabs() {
        ...
        WebElement tabList = new WebDriverWait(driver, Duration.ofSeconds(3))
        ...
        WebElement eudiOpenidTab = driver.findElement(By.cssSelector("[data-testid='protocol-tab-eudi-openid4vp']"));
        assertThat(eudiOpenidTab.getAttribute("aria-selected")).isEqualTo("false");

        WebElement eudiIsoTab = driver.findElement(By.cssSelector("[data-testid='protocol-tab-eudi-iso-18013-5']"));
        assertThat(eudiIsoTab.getAttribute("aria-selected")).isEqualTo("false");

        WebElement eudiSiopTab = driver.findElement(By.cssSelector("[data-testid='protocol-tab-eudi-siopv2']"));
        ...
        WebElement evaluateSection = ocraPanel.findElement(By.cssSelector("[data-testid='ocra-evaluate-panel']"));
        assertThat(evaluateSection.getAttribute("hidden"))
                .as("Evaluation panel should be visible by default")
                .isNull();
        WebElement evaluateForm = evaluateSection.findElement(By.cssSelector("[data-testid='ocra-evaluate-form']"));
        assertThat(evaluateForm).isNotNull();

        WebElement replaySection = driver.findElement(By.cssSelector("[data-testid='ocra-replay-panel']"));
        assertThat(replaySection.getAttribute("hidden"))
                .as("Replay panel should start hidden")
                .isNotNull();
        WebElement replayForm = replaySection.findElement(By.cssSelector("[data-testid='ocra-replay-form']"));
        assertThat(replayForm).isNotNull();

        WebElement replayToggle = driver.findElement(By.cssSelector("[data-testid='ocra-mode-select-replay']"));
        replayToggle.click();
        ...
        WebElement evaluateToggle = driver.findElement(By.cssSelector("[data-testid='ocra-mode-select-evaluate']"));
        ...
        WebElement hotpPanelTabs = hotpPanel.findElement(By.cssSelector("[data-testid='hotp-panel-tabs']"));
        WebElement hotpEvaluateTab =
                hotpPanelTabs.findElement(By.cssSelector("[data-testid='hotp-panel-tab-evaluate']"));
        WebElement hotpReplayTab = hotpPanelTabs.findElement(By.cssSelector("[data-testid='hotp-panel-tab-replay']"));
        ...
        WebElement hotpModeToggle = hotpPanel.findElement(By.cssSelector("[data-testid='hotp-mode-toggle']"));
        ...
        WebElement storedToggle = hotpModeToggle.findElement(By.cssSelector("[data-testid='hotp-mode-select-stored']"));
        WebElement inlineToggle = hotpModeToggle.findElement(By.cssSelector("[data-testid='hotp-mode-select-inline']"));
        ...
        WebElement inlineCard = new WebDriverWait(driver, Duration.ofSeconds(3))
        ...
        new WebDriverWait(driver, Duration.ofSeconds(3)).until(panel -> totpPanel.getAttribute("hidden") == null);
        ...
        new WebDriverWait(driver, Duration.ofSeconds(3)).until(panel -> emvPanel.getAttribute("hidden") == null);
        assertThat(modeToggle.getAttribute("hidden"))
                .as("Mode toggle should hide for non-OCRA protocols")
                .isNotNull();
        assertThat(ocraPanel.getAttribute("hidden")).isNotNull();
        ...
        new WebDriverWait(driver, Duration.ofSeconds(3)).until(panel -> fidoPanel.getAttribute("hidden") == null);
        WebElement fidoEvaluateHeading = fidoPanel.findElement(By.cssSelector("#fido2-evaluate-heading"));
        assertThat(fidoEvaluateHeading.getText()).contains("Evaluate a WebAuthn assertion");
        WebElement fidoReplayTab = fidoPanel.findElement(By.cssSelector("[data-testid='fido2-panel-tab-replay']"));
        assertThat(fidoReplayTab.getText()).containsIgnoringCase("Replay");

        eudiOpenidTab.click();
        WebElement eudiOpenidPanel = driver.findElement(By.cssSelector("[data-protocol-panel='eudi-openid4vp']"));
        new WebDriverWait(driver, Duration.ofSeconds(3)).until(panel -> eudiOpenidPanel.getAttribute("hidden") == null);
        assertThat(eudiOpenidPanel.findElement(By.tagName("h2")).getText()).contains("OpenID4VP");

        eudiIsoTab.click();
        WebElement eudiIsoPanel = driver.findElement(By.cssSelector("[data-protocol-panel='eudi-iso-18013-5']"));
        new WebDriverWait(driver, Duration.ofSeconds(3)).until(panel -> eudiIsoPanel.getAttribute("hidden") == null);
        assertThat(eudiIsoPanel.findElement(By.tagName("h2")).getText()).contains("ISO/IEC 18013-5");

        eudiSiopTab.click();
        WebElement eudiSiopPanel = driver.findElement(By.cssSelector("[data-protocol-panel='eudi-siopv2']"));
        new WebDriverWait(driver, Duration.ofSeconds(3)).until(panel -> eudiSiopPanel.getAttribute("hidden") == null);
        assertThat(eudiSiopPanel.findElement(By.tagName("h2")).getText()).contains("SIOPv2");

        ocraTab.click();
        new WebDriverWait(driver, Duration.ofSeconds(3)).until(panel -> modeToggle.getAttribute("hidden") == null);
    ...
    void evaluationResultHeadingTypographyMatches() {
        ...
        WebElement ocraHeading = new WebDriverWait(driver, Duration.ofSeconds(3))
                .until(ExpectedConditions.presenceOfElementLocated(
                        By.cssSelector("[data-testid='ocra-result-panel'] #result-heading")));
        String ocraFontSize = computeFontSize(ocraHeading);

        WebElement hotpTab = new WebDriverWait(driver, Duration.ofSeconds(3))
                .until(ExpectedConditions.elementToBeClickable(By.cssSelector("[data-testid='protocol-tab-hotp']")));
        hotpTab.click();

        WebElement hotpPanel = new WebDriverWait(driver, Duration.ofSeconds(3))
                .until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("[data-protocol-panel='hotp']")));
        new WebDriverWait(driver, Duration.ofSeconds(3)).until(d -> hotpPanel.getAttribute("hidden") == null);

        WebElement hotpHeading = new WebDriverWait(driver, Duration.ofSeconds(3))
                .until(ExpectedConditions.presenceOfElementLocated(
    ...
    void queryParametersRestoreConsoleState() {
        ...
        WebElement modeToggle = new WebDriverWait(driver, Duration.ofSeconds(3))
        ...
        WebElement replayPanel = driver.findElement(By.cssSelector("[data-testid='ocra-replay-panel']"));
        assertThat(replayPanel.getAttribute("hidden"))
                .as("Replay panel should be visible when tab=replay")
                .isNull();
        WebElement evaluatePanel = driver.findElement(By.cssSelector("[data-testid='ocra-evaluate-panel']"));
        assertThat(evaluatePanel.getAttribute("hidden"))
                .as("Evaluation panel should hide when tab=replay")
                .isNotNull();

        List<String[]> protocolExpectations = List.of(
        ...
        for (String[] expectation : protocolExpectations) {
            ...
            WebElement panel = driver.findElement(By.cssSelector("[data-protocol-panel='" + panelKey + "']"));
            ...
            WebElement ocraModeToggle = driver.findElement(By.cssSelector("[data-testid='ocra-mode-toggle']"));
    ...
    void protocolTabNavigationOmitsLegacyQueryParameters() {
        driver.get(baseUrl("/ui/console?protocol=ocra&tab=replay&mode=stored"
        ...
        List<WebElement> tabs = List.of(
                wait.until(
                        ExpectedConditions.elementToBeClickable(By.cssSelector("[data-testid='protocol-tab-hotp']"))),
    ...
    void protocolTabsResetEvaluateInlineDefaults() {
        ...
        WebElement ocraEvaluateButton = wait.until(
                ExpectedConditions.elementToBeClickable(By.cssSelector("[data-testid='ocra-mode-select-evaluate']")));
        ocraEvaluateButton.click();
        wait.until(webDriver -> "evaluate"
                .equals(webDriver
                        .findElement(By.cssSelector("[data-testid='ocra-mode-toggle']"))
                        .getAttribute("data-mode")));

        WebElement ocraStoredRadio = wait.until(ExpectedConditions.elementToBeClickable(By.id("mode-credential")));
        ocraStoredRadio.click();
        wait.until(webDriver -> webDriver.findElement(By.id("mode-credential")).isSelected());

        WebElement ocraReplayButton = wait.until(
                ExpectedConditions.elementToBeClickable(By.cssSelector("[data-testid='ocra-mode-select-replay']")));
        ocraReplayButton.click();
        wait.until(webDriver -> "replay"
                .equals(webDriver
                        .findElement(By.cssSelector("[data-testid='ocra-mode-toggle']"))
                        .getAttribute("data-mode")));
        ...
        WebElement ocraTab = wait.until(
                ExpectedConditions.elementToBeClickable(By.cssSelector("[data-testid='protocol-tab-ocra']")));
        ocraTab.click();
        ...
        WebElement hotpEvaluateTab = driver.findElement(By.cssSelector("[data-testid='hotp-panel-tab-evaluate']"));
        assertThat(hotpEvaluateTab.getAttribute("aria-selected")).isEqualTo("true");

        WebElement hotpModeToggle = driver.findElement(By.cssSelector("[data-testid='hotp-mode-toggle']"));
        assertThat(hotpModeToggle.getAttribute("data-mode")).isEqualTo("inline");
        assertThat(driver.findElement(By.cssSelector("[data-testid='hotp-mode-select-inline']"))
                        .isSelected())
                .isTrue();
        assertThat(driver.findElement(By.cssSelector("[data-testid='hotp-mode-select-stored']"))
                        .isSelected())
                .isFalse();
        ...
        WebElement totpEvaluateTab = driver.findElement(By.cssSelector("[data-testid='totp-panel-tab-evaluate']"));
        assertThat(totpEvaluateTab.getAttribute("aria-selected")).isEqualTo("true");

        WebElement totpModeToggle = driver.findElement(By.cssSelector("[data-testid='totp-mode-toggle']"));
        assertThat(totpModeToggle.getAttribute("data-mode")).isEqualTo("inline");
        assertThat(driver.findElement(By.cssSelector("[data-testid='totp-mode-select-inline']"))
                        .isSelected())
                .isTrue();
        assertThat(driver.findElement(By.cssSelector("[data-testid='totp-mode-select-stored']"))
                        .isSelected())
                .isFalse();
        ...
        WebElement fidoEvaluateTab = driver.findElement(By.cssSelector("[data-testid='fido2-panel-tab-evaluate']"));
        assertThat(fidoEvaluateTab.getAttribute("aria-selected")).isEqualTo("true");

        WebElement fidoModeToggle = driver.findElement(By.cssSelector("[data-testid='fido2-evaluate-mode-toggle']"));
        assertThat(fidoModeToggle.getAttribute("data-mode")).isEqualTo("inline");
        assertThat(driver.findElement(By.cssSelector("[data-testid='fido2-evaluate-mode-select-inline']"))
                        .isSelected())
                .isTrue();
        assertThat(driver.findElement(By.cssSelector("[data-testid='fido2-evaluate-mode-select-stored']"))
                        .isSelected())
                .isFalse();
    }
    ...
    void storedModeDeepLinksPersistAcrossProtocols() {
        List<StoredModeExpectation> expectations = List.of(
    ...
    void fido2ConsoleProvidesCanonicalApi() {
        ...
        Boolean legacyModeFunction =
                (Boolean) executor.executeScript("return typeof window.Fido2Console.setMode === 'function';");
        ...
        WebElement replayToggle = driver.findElement(By.cssSelector("[data-testid='fido2-replay-mode-toggle']"));
        ...
        WebElement evaluateToggle = driver.findElement(By.cssSelector("[data-testid='fido2-evaluate-mode-toggle']"));
    ...
    void ocraPresetHintMatchesRequirement() {
        ...
        WebElement inlineToggle = new WebDriverWait(driver, Duration.ofSeconds(3))
        ...
        new WebDriverWait(driver, Duration.ofSeconds(3)).until(d -> inlineParameters.getAttribute("hidden") == null);
        ...
        WebElement replayHint = new WebDriverWait(driver, Duration.ofSeconds(3))
    ...
    void hotpTabsPersistQueryParameters() {
        ...
        By hotpPanelLocator = By.cssSelector("[data-protocol-panel='hotp']");
        WebElement hotpPanel = new WebDriverWait(driver, Duration.ofSeconds(5))
        ...
        WebElement evaluateTabButton = new WebDriverWait(driver, Duration.ofSeconds(3))
        ...
        setPanelVisibilityExpectation(driver.findElement(By.cssSelector("[data-hotp-panel='replay']")), false);

        driver.navigate().refresh();

        replayTabButton = new WebDriverWait(driver, Duration.ofSeconds(5))
        ...
        new WebDriverWait(driver, Duration.ofSeconds(3))
                .until(d -> d.getCurrentUrl().contains("tab=evaluate"));
        setPanelVisibilityExpectation(driver.findElement(By.cssSelector("[data-hotp-panel='evaluate']")), false);
    }
    ...
    void hotpReplayDeepLinkSurvivesRefresh() {
        ...
        replayTab = new WebDriverWait(driver, Duration.ofSeconds(5))
                .until(ExpectedConditions.presenceOfElementLocated(hotpReplayTabLocator));
        new WebDriverWait(driver, Duration.ofSeconds(3))
                .until(d -> d.getCurrentUrl().contains("protocol=hotp"));
        new WebDriverWait(driver, Duration.ofSeconds(3))
    ...
    void protocolInfoTriggerTracksActiveProtocolState() {
        ...
        if ("true".equals(surface.getAttribute("data-open"))) {
            WebElement closeButton = surface.findElement(By.cssSelector("[data-testid='protocol-info-close']"));
            closeButton.click();
            waitForAttribute(surface, "data-open", "false");
        }

        WebElement trigger = new WebDriverWait(driver, Duration.ofSeconds(3))
                .until(ExpectedConditions.presenceOfElementLocated(
        ...
        List<String> protocolOrder =
                List.of("ocra", "hotp", "totp", "emv", "fido2", "eudi-openid4vp", "eudi-iso-18013-5", "eudi-siopv2");

        for (String protocol : protocolOrder) {
            if (!"ocra".equals(protocol)) {
                WebElement tab = driver.findElement(By.cssSelector("[data-testid='protocol-tab-" + protocol + "']"));
                tab.click();
            }
    ...
    void protocolInfoSurfaceSupportsShortcutsAndExpansion() {
        ...
        WebElement infoTrigger = new WebDriverWait(driver, Duration.ofSeconds(3))
                .until(ExpectedConditions.presenceOfElementLocated(
                        By.cssSelector("[data-testid='protocol-info-trigger']")));

        WebElement initialSurface = waitForProtocolInfoSurface();
        if ("true".equals(initialSurface.getAttribute("data-open"))) {
            WebElement closeButton = initialSurface.findElement(By.cssSelector("[data-testid='protocol-info-close']"));
            closeButton.click();
        ...
        WebElement expandButton = surface.findElement(By.cssSelector("[data-testid='protocol-info-expand']"));
        expandButton.click();
    ...
    void protocolInfoSurfaceUpdatesAcrossProtocols() {
        ...
        assertThat(surface.findElement(By.cssSelector("[data-testid='protocol-info-panel-overview']"))
    ...
    private List<String> sectionKeys(WebElement surface) {
        return surface.findElements(By.cssSelector("[data-testid='protocol-info-accordion-header']")).stream()
                .map(header -> header.getAttribute("data-section-key"))
                .collect(Collectors.toList());
    }

    private String protocolHeadingText(WebElement surface) {
        return surface.findElement(By.cssSelector("[data-testid='protocol-info-title']"))
                .getText();
    }

    private void setPanelVisibilityExpectation(WebElement panel, boolean hidden) {
        if (hidden) {
            assertThat(panel.getAttribute("hidden"))
                    .as("Expected panel to be hidden")
                    .isNotNull();
        } else {
            assertThat(panel.getAttribute("hidden"))
                    .as("Expected panel to be visible")
                    .isNull();
        }
    }
    ...
    private void waitForStoredState(StoredModeExpectation expectation) {
        WebElement panel = new WebDriverWait(driver, Duration.ofSeconds(5))
                .until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(expectation.panelSelector())));
        ...
        WebElement storedRadio = new WebDriverWait(driver, Duration.ofSeconds(5))
                .until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(expectation.storedRadioSelector())));
        WebElement inlineRadio = new WebDriverWait(driver, Duration.ofSeconds(5))
                .until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(expectation.inlineRadioSelector())));
    ...
    private void waitForHotpReplayStoredState() {
        ...
        WebElement replayTab = wait.until(
                ExpectedConditions.presenceOfElementLocated(By.cssSelector("[data-testid='hotp-panel-tab-replay']")));
        wait.until(ExpectedConditions.attributeToBe(replayTab, "aria-selected", "true"));

        WebElement modeToggle = wait.until(
                ExpectedConditions.presenceOfElementLocated(By.cssSelector("[data-testid='hotp-replay-mode-toggle']")));
        wait.until(d -> "stored".equals(modeToggle.getAttribute("data-mode")));

        WebElement storedRadio = wait.until(ExpectedConditions.presenceOfElementLocated(
                By.cssSelector("[data-testid='hotp-replay-mode-select-stored']")));
        WebElement inlineRadio = wait.until(ExpectedConditions.presenceOfElementLocated(
        ...
        WebElement storedSection = wait.until(ExpectedConditions.presenceOfElementLocated(
    ...
    private void waitForFido2ReplayStoredState() {
        ...
        WebElement replayTab = wait.until(
                ExpectedConditions.presenceOfElementLocated(By.cssSelector("[data-testid='fido2-panel-tab-replay']")));
        wait.until(ExpectedConditions.attributeToBe(replayTab, "aria-selected", "true"));

        WebElement modeToggle = wait.until(ExpectedConditions.presenceOfElementLocated(
