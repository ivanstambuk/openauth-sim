...
class OcraEvaluationControllerTest {
  ...
  @MockBean private OcraEvaluationService service;
  ...
  void evaluateReturnsResponse() throws Exception {
    ...
    OcraEvaluationRequest request =
        new OcraEvaluationRequest(
            null, "OCRA-1", "31323334", "12345678", null, null, null, null, null, null);
  ...
  void evaluateHandlesValidationError() throws Exception {
    OcraEvaluationValidationException exception =
        new OcraEvaluationValidationException(
            "rest-ocra-telemetry",
            "OCRA-1",
            "sessionHex",
            "session_required",
  ...
  void evaluateHandlesUnexpectedError() throws Exception {
    when(service.evaluate(any(OcraEvaluationRequest.class)))
