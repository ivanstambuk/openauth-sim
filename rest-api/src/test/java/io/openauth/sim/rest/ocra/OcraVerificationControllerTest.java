...
class OcraVerificationControllerTest {
  ...
  @MockBean private OcraVerificationService service;
  ...
  void verifyReturnsMatch() throws Exception {
    OcraVerificationMetadata metadata =
        new OcraVerificationMetadata(
            ...
            "match");
    when(service.verify(
            any(OcraVerificationRequest.class), any(OcraVerificationAuditContext.class)))
  ...
  void verifySurfacesValidationErrors() throws Exception {
    OcraVerificationValidationException exception =
        new OcraVerificationValidationException(
