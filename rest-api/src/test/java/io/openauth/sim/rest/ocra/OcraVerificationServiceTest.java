...
class OcraVerificationServiceTest {
    ...
    void invalidChallengeFormatTriggersValidationFailure() {
        ...
        OcraVerificationValidationException exception = assertThrows(
                ...
                () -> service.verify(request, new OcraVerificationAuditContext("req-invalid", null, null)));
    ...
    void inlineVerificationMismatch() {
        ...
        OcraVerificationAuditContext auditContext = new OcraVerificationAuditContext("req-inline-2", null, null);
    ...
    void inlineSecretMissingValidation() {
        ...
        OcraVerificationValidationException exception = assertThrows(
                OcraVerificationValidationException.class,
                () -> service.verify(request, new OcraVerificationAuditContext("req-secret", null, null)));
    ...
    void storedCredentialMissing() {
        ...
        OcraVerificationValidationException exception = assertThrows(
                OcraVerificationValidationException.class,
                () -> service.verify(request, new OcraVerificationAuditContext("req-missing", null, null)));
    ...
    void storedAndInlineConflict() {
        ...
        OcraVerificationValidationException exception = assertThrows(
                OcraVerificationValidationException.class,
                () -> service.verify(request, new OcraVerificationAuditContext("req-conflict", null, null)));
    ...
    void resolverFailureTriggersUnexpectedError() {
        ...
        IllegalStateException exception = assertThrows(
                ...
                () -> service.verify(
                        storedRequest("stored-token"), new OcraVerificationAuditContext("req-unexpected", null, null)));
    ...
    void storedVerificationUnexpectedError() {
        ...
        IllegalStateException exception = assertThrows(
                IllegalStateException.class,
                () -> service.verify(request, new OcraVerificationAuditContext("req-offline", null, null)));
    ...
    void corruptedStoredCredentialTriggersUnexpected() {
        ...
        java.util.Map<String, String> corruptedAttributes = new java.util.HashMap<>(credential.attributes());
        ...
        CredentialStore corruptedStore = new CredentialStore() {
            @Override
    ...
    private OcraCredentialDescriptor inlineDescriptor() {
        return new OcraCredentialFactory()
                .createDescriptor(new OcraCredentialFactory.OcraCredentialRequest(
                        "stored-token",
    ...
    private void assertTelemetryMessageContains(String token) {
        boolean matched = handler.records.stream().map(LogRecord::getMessage).anyMatch(msg -> msg.contains(token));
        if (!matched) {
