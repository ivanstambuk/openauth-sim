...
class OcraOperatorSampleDataTest {
  ...
  void findByPresetKeyBlank() {
    Optional<OcraOperatorSampleData.SampleDefinition> definition =
        OcraOperatorSampleData.findByPresetKey("   ");
  ...
  void findBySuiteBlank() {
    Optional<OcraOperatorSampleData.SampleDefinition> definition =
        OcraOperatorSampleData.findBySuite("  ");
  ...
  void sampleDefinitionHandlesNullMetadata() {
    OcraOperatorSampleData.SampleDefinition definition =
        new OcraOperatorSampleData.SampleDefinition(
            "key",
            "label",
            "credential",
