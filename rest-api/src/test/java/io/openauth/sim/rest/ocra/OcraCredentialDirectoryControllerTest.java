...
class OcraCredentialDirectoryControllerTest {
    ...
    void listCredentialsFiltersAndSorts() {
        ...
        Credential generic = new Credential(
                "Ignored",
    ...
    void listCredentialsAnnotatesRfcVectors() {
        Credential rfcVector = credential(
                "sample-qa08-s064",
                "OCRA-1:HOTP-SHA256-8:QA08-S064",
                Map.of(OcraCredentialPersistenceAdapter.ATTR_METADATA_PREFIX + "presetKey", "qa08-s064"));
        ...
        assertEquals(
                "sample-qa08-s064 (OCRA-1:HOTP-SHA256-8:QA08-S064, RFC 6287)",
                summaries.get(0).getLabel());
    }

    @Test
    @DisplayName("returns curated sample when preset metadata present")
    void fetchSampleWithPresetMetadata() {
        Credential credential = credentialWithMetadata(
                "sample-qa08-s064",
                "OCRA-1:HOTP-SHA256-8:QA08-S064",
                Map.of(OcraCredentialPersistenceAdapter.ATTR_METADATA_PREFIX + "presetKey", "qa08-s064"));
    ...
    private Credential credentialWithMetadata(String name, String suite, Map<String, String> metadata) {
