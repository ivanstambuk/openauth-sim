...
final class ProtocolInfoJavaScriptTest {
    ...
    void protocolInfoApiExposesDescriptorSchemaWithEscaping() {
        ...
        Map<String, Object> evaluation = (Map<String, Object>) ((JavascriptExecutor) driver)
                .executeScript("return (function () {\n"
    ...
    void protocolInfoStatePersistsUsingVersionedKeys() {
        ...
        WebElement howItWorksHeader = surface.findElement(
                By.cssSelector("[data-testid='protocol-info-accordion-header'][data-section-key='how-it-works']"));
        ...
        @SuppressWarnings("unchecked")
        Map<String, Object> storageState = (Map<String, Object>) ((JavascriptExecutor) driver)
        ...
        ((JavascriptExecutor) driver)
                .executeScript("window.localStorage.removeItem('protoInfo.v1.seen.totp');\n"
        ...
        String totpSeen = (String) ((JavascriptExecutor) driver)
    ...
    void protocolInfoDispatchesCustomEvents() {
        ...
        WebElement surface = waitForProtocolInfoSurface();
        if ("true".equals(surface.getAttribute("data-open"))) {
            WebElement initialCloseButton = surface.findElement(By.cssSelector("[data-testid='protocol-info-close']"));
            initialCloseButton.click();
            waitForAttribute(surface, "data-open", "false");
        }

        ((JavascriptExecutor) driver)
                .executeScript("window.__protocolInfoEvents = [];\n"
        ...
        assertThat(events)
                ...
                .anySatisfy(event -> assertThat(event.get("detail"))
    ...
    void protocolInfoModalTrapsFocusAndUpdatesAccessibilityState() {
        ...
        String consoleAriaHidden = (String) ((JavascriptExecutor) driver)
                .executeScript("return document.querySelector('.operator-console').getAttribute('aria-hidden');");
        ...
        String restoredAriaHidden = (String) ((JavascriptExecutor) driver)
                .executeScript("return document.querySelector('.operator-console').getAttribute('aria-hidden');");
    ...
    void protocolInfoHonoursReducedMotionPreference() {
        ...
        ((JavascriptExecutor) driver)
                .executeScript("window.matchMedia = function (query) {\n"
        ...
        String resetSurfaceMotion = (String)
                ((JavascriptExecutor) driver)
                        .executeScript(
                                "return document.querySelector('[data-testid=\\'protocol-info-surface\\']').getAttribute('data-motion');");
