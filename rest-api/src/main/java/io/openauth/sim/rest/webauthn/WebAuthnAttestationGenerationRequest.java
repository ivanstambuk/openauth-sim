...
record WebAuthnAttestationGenerationRequest(
    ...
    @Schema(description = "Attestation format label", example = "packed") @JsonProperty("format")
        String format,
    @Schema(description = "Expected relying party ID", example = "example.org")
        @JsonProperty("relyingPartyId")
        String relyingPartyId,
    @Schema(description = "Expected origin", example = "https://example.org")
        @JsonProperty("origin")
        String origin,
    ...
    @Schema(
        ...
        String signingMode,
    @Schema(description = "Inline PEM encoded custom root certificates")
        @JsonProperty("customRootCertificates")
        List<String> customRootCertificates,
    @Schema(description = "Optional seed preset id when overrides are applied")
        @JsonProperty("seedPresetId")
        String seedPresetId,
