...
class WebAuthnAttestationController {
  ...
  @Operation(
      ...
      responses = {
        @ApiResponse(
            ...
            content =
                @Content(schema = @Schema(implementation = WebAuthnAttestationResponse.class))),
        @ApiResponse(
            responseCode = "422",
            description = "Request invalid",
            content =
                @Content(
                    schema = @Schema(implementation = WebAuthnAttestationErrorResponse.class))),
        @ApiResponse(
            responseCode = "500",
            description = "Unexpected error",
            content =
                @Content(schema = @Schema(implementation = WebAuthnAttestationErrorResponse.class)))
      })
  @PostMapping("/attest")
  ResponseEntity<WebAuthnAttestationResponse> attest(
      @RequestBody WebAuthnAttestationGenerationRequest request) {
  ...
  ResponseEntity<WebAuthnAttestationResponse> replay(
      @RequestBody WebAuthnAttestationReplayRequest request) {
  ...
  ResponseEntity<WebAuthnAttestationErrorResponse> handleValidation(
    ...
    WebAuthnAttestationErrorResponse body =
        new WebAuthnAttestationErrorResponse(
            "invalid",
