...
class WebAuthnEvaluationController {
    ...
    @Operation(
            ...
            responses = {
                @ApiResponse(
                        ...
                        content = @Content(schema = @Schema(implementation = WebAuthnEvaluationResponse.class))),
                @ApiResponse(
                        responseCode = "422",
                        description = "Request invalid",
                        content = @Content(schema = @Schema(implementation = WebAuthnEvaluationErrorResponse.class))),
                @ApiResponse(
                        responseCode = "500",
    ...
    ResponseEntity<WebAuthnEvaluationResponse> evaluateStored(@RequestBody WebAuthnStoredEvaluationRequest request) {
    ...
    ResponseEntity<WebAuthnEvaluationResponse> evaluateInline(@RequestBody WebAuthnInlineEvaluationRequest request) {
