...
class OcraVerificationController {
  ...
  @Operation(
      ...
      description =
          "Replays an OCRA execution with the supplied OTP and context to determine whether the"
  ...
  ResponseEntity<OcraVerificationErrorResponse> handleValidation(
  ...
  ResponseEntity<OcraVerificationErrorResponse> handleUnexpected(RuntimeException exception) {
    OcraVerificationErrorResponse body =
        new OcraVerificationErrorResponse(
  ...
  private OcraVerificationAuditContext buildAuditContext(HttpServletRequest request) {
    ...
    String clientId =
        Optional.ofNullable(request.getHeader("X-Client-ID"))
            .map(String::trim)
            .filter(value -> !value.isEmpty())
            .orElse(null);

    String operatorPrincipal =
        Optional.ofNullable(request.getRemoteUser())
            .map(String::trim)
            .filter(value -> !value.isEmpty())
            .orElse(null);
