...
record WebAuthnAttestedCredential(
        @Schema(description = "Relying party identifier associated with the credential", example = "example.org")
        ...
        @Schema(description = "Authenticator signature algorithm label", example = "ES256") @JsonProperty("algorithm")
        String algorithm,
