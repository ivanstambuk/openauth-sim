...
class TotpEvaluationController {
  ...
  @Operation(
      ...
      responses = {
        ...
        @ApiResponse(
            ...
            content =
                @Content(schema = @Schema(implementation = TotpEvaluationErrorResponse.class))),
        @ApiResponse(
            responseCode = "500",
  ...
  ResponseEntity<TotpEvaluationResponse> evaluateStored(
      @RequestBody TotpStoredEvaluationRequest request) {
  ...
  ResponseEntity<TotpEvaluationResponse> evaluateInline(
      @RequestBody TotpInlineEvaluationRequest request) {
    TotpEvaluationResponse response = service.evaluateInline(request);
    return ResponseEntity.ok(response);
  }

  @ExceptionHandler(TotpEvaluationValidationException.class)
  ResponseEntity<TotpEvaluationErrorResponse> handleValidation(
      TotpEvaluationValidationException exception) {
    TotpEvaluationErrorResponse body =
        new TotpEvaluationErrorResponse(
  ...
  ResponseEntity<TotpEvaluationErrorResponse> handleUnexpected(
