...
record WebAuthnAttestationMetadata(
    ...
    @Schema(description = "Flag indicating whether trust anchors were provided")
        @JsonProperty("anchorProvided")
        Boolean anchorProvided,
    @Schema(
            description =
                "Flag indicating whether provided trust anchors matched the certificate chain")
    ...
    @Schema(description = "Derived source describing which anchors were used", example = "provided")
        ...
        String anchorSource,
    @Schema(
            description = "Indicates whether anchors were loaded fresh or retrieved from cache",
            example = "fresh")
        @JsonProperty("anchorMode")
        String anchorMode,
    @Schema(
            description =
                "SHA-256 fingerprint of the attestation certificate when anchors were provided")
    ...
    @Schema(description = "Warnings generated while processing trust anchors")
        @JsonProperty("anchorWarnings")
    ...
    @Schema(description = "Input source used to build the request", example = "manual")
