...
@Schema(
    ...
    description =
        "Request payload for replaying a WebAuthn attestation verification with optional trust anchors.")
record WebAuthnAttestationReplayRequest(
    ...
    @Schema(
            description =
                "PEM encoded X.509 trust anchors to validate the attestation certificate chain")
