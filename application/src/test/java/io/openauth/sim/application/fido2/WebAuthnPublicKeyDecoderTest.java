...
final class WebAuthnPublicKeyDecoderTest {
    ...
    private static String pemFromEcJwk(Map<String, Object> jwk, WebAuthnSignatureAlgorithm algorithm) {
        try {
    ...
    private static String curveName(WebAuthnSignatureAlgorithm algorithm) {
        return switch (algorithm) {
            ...
            default -> throw new IllegalArgumentException("Unsupported EC algorithm for test fixture: " + algorithm);
        };
    }
