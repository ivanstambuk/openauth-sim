...
final class OcraTelemetryContractTest {
    ...
    void ocraEvaluationValidationFramePropagatesSanitizedFlag() {
        ...
        TelemetryFrame frame = adapter.validationFailure(
                TelemetryContractTestSupport.telemetryId(), "validation_error", "suite is required", true, fields);
    ...
    void ocraSeedingAdapterProducesSeedStatusFrame() {
        ...
        TelemetryFrame frame = adapter.status(
                "seeded", TelemetryContractTestSupport.telemetryId(), "seeded", true, null, Map.of("addedCount", 5));
