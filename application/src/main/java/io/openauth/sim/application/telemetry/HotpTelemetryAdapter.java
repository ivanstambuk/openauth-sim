...
/** Builds canonical telemetry frames for HOTP flows. */
public final class HotpTelemetryAdapter {

    private final String event;

    HotpTelemetryAdapter(String event) {
        this.event = Objects.requireNonNull(event, "event");
    }

    public TelemetryFrame success(String telemetryId, Map<String, Object> fields) {
        return frame("success", telemetryId, "match", true, null, fields);
    }
