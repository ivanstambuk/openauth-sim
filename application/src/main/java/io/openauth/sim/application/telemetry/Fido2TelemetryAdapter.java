...
public final class Fido2TelemetryAdapter {
    ...
    public TelemetryFrame invalid(String telemetryId, String reasonCode, String reason, Map<String, Object> fields) {
        return status("invalid", telemetryId, reasonCode, true, reason, fields);
    }

    public TelemetryFrame error(String telemetryId, String reasonCode, String reason, Map<String, Object> fields) {
