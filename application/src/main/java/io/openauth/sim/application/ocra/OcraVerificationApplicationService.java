...
public final class OcraVerificationApplicationService {
    ...
    private VerificationResult verifyStored(NormalizedRequest.Stored stored, OcraVerificationContext context) {
        ...
        return mapResult(result, descriptor.suite().value(), true, descriptor.name(), responseDigits, stored);
    }

    private VerificationResult verifyInline(NormalizedRequest.Inline inline, OcraVerificationContext context) {
        ...
        int responseDigits = descriptor.suite().cryptoFunction().responseDigits();
        return mapResult(result, descriptor.suite().value(), false, descriptor.name(), responseDigits, inline);
    }
