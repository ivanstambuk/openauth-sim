...
public final class WebAuthnReplayApplicationService {
  ...
  public record ReplayResult(
    ...
    public ReplayResult {
      ...
      supplementalFields =
          Map.copyOf(
              new LinkedHashMap<>(supplementalFields == null ? Map.of() : supplementalFields));
    }
  ...
  private ReplayResult fromEvaluation(
      WebAuthnEvaluationApplicationService.EvaluationResult evaluationResult,
      String credentialSource) {

    Map<String, Object> supplemental = new LinkedHashMap<>();
    supplemental.put("evaluationStatus", evaluationResult.telemetry().status().name());
