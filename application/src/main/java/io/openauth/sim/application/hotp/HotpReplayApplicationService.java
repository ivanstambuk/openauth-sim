...
public final class HotpReplayApplicationService {
  ...
  private ReplayResult replayStored(ReplayCommand.Stored command) {
    ...
    try {
      ...
      Integer digits = storedCredential != null ? storedCredential.descriptor().digits() : null;
      return unexpectedErrorResult(
          command.credentialId(), true, "stored", algorithm, digits, counter, ex);
    }
  }
  ...
  private ReplayResult successResult(
    ...
    Map<String, Object> fields =
        replayFields(credentialSource, credentialId, algorithm, digits, counter, counter);
