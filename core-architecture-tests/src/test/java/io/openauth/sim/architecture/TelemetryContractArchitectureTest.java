...
final class TelemetryContractArchitectureTest {
  ...
  private static final String APPLICATION_TELEMETRY_PACKAGE =
      "io.openauth.sim.application.telemetry";
  ...
  void facadeTelemetryClassesAreRelocated() {
    JavaClasses imported =
        new ClassFileImporter().importPackages(CLI_PACKAGE, REST_PACKAGE, UI_PACKAGE);
