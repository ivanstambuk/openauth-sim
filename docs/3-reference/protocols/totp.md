...
![TOTP secret provisioning](diagrams/totp-provisioning.png)
...
![TOTP authentication (basic)](diagrams/totp-authentication-basic.png)
...
![TOTP clock drift and time-step window](diagrams/totp-drift-window.png)
...
![TOTP time-step view (verifier perspective)](diagrams/totp-time-window.png)
