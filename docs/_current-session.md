...
|------------|--------|----------------|----------------|-------|
| Feature 026 – FIDO2/WebAuthn Attestation Support | In progress | T2622 (CLI Manual parity) | Owner sign-off & release notes | REST façade rejects unsupported `inputSource` values, the operator UI auto-detects overrides, and the CLI now honours Manual mode with matching validation/telemetry; analysis gate passed 2025-10-20, remaining work is owner sign-off and public release docs. |
