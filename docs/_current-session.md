...
| Feature 035 – Evaluate & Replay Audit Tracing | In progress | T3535 (Verbose trace clearing on context switches) | T3528 – OCRA truncation tier gating | UI scripts now clear verbose traces on protocol/tab/mode changes (Option B), with OCRA/TOTP Selenium assertions verifying the behaviour. Remaining scope covers OCRA tier gating (T3528) and message integrity docs (T3529). |
