...
- Last green commands: `./gradlew --no-daemon :application:test` (2025-11-07 – T4011 direct_post.jwt encryption) and `./gradlew --no-daemon spotlessApply check` (2025-11-07 – Feature 040 HAIP encryption/telemetry validation).
