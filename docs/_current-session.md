...
|------------|--------|----------------|----------------|-------|
| Feature 039 – EMV/CAP Simulation Services | In progress | T3933 – Stored preset secret hiding | T3934–T3938 queued | Stored-mode credential fields hide via `emv-stored-mode`; upcoming tasks cover label removal, customer input grouping, inline preset hydration, transaction grouping, and session derivation grouping before acceptance. |
