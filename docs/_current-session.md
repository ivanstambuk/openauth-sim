...
|------------|--------|----------------|----------------|-------|
| Feature 039 – EMV/CAP Simulation Services | In progress | T3933 – Stored preset secret hiding | Owner acceptance sign-off | Stored-mode credential fields now hide via the shared `emv-stored-mode` CSS class; JS, Selenium, and JS unit suites refreshed alongside spec/plan/task updates. Await owner sign-off to close the feature. |
