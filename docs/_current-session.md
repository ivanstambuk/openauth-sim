...
| Feature 026 – FIDO2/WebAuthn Attestation Support | In progress | I44 – Stored replay trust-anchor summary | I45 – Stored credential secret sanitisation | Re-opened to strip authenticator private keys from stored credential/sample responses, update operator UI to masked placeholders, and adjust backend services to keep signing keys server-side. |
