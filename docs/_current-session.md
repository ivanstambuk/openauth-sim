...
- Last green commands: `./gradlew --no-daemon :application:test :cli:test :rest-api:test :ui:test pmdMain pmdTest spotlessApply check` (2025-11-02).
- Build status: Feature 037 shared-secret polish (T3707) wrapped; Feature 038 remains complete with aligned UI previews and accessibility documentation. Feature 039 EMV/CAP simulation has been reopened for replay parity—spec/plan/tasks now track T3910–T3915—while Feature 029 PMD hardening (T2902) stays in flight as the other active increment.
- Handoff note (2025-11-02): Feature 037 remains ready to archive; Feature 038 stays closed after accessibility review, documentation sync, and full quality gate. Feature 039 replay work kicks off with T3910 (red tests) before implementation increments T3911–T3914; T3915 will deliver the follow-up documentation/quality gate. Feature 029 PMD hardening (T2902) remains the parallel focus.
...
- Latest closure: Feature 037 – Base32 Inline Secret Support closed 2025-11-01 after dynamic shared-secret messaging shipped and `./gradlew --no-daemon :rest-api:test :ui:test` passed. Feature 026 – FIDO2/WebAuthn Attestation Support accepted 2025-10-31 after trust-anchor summaries were validated and the full Gradle suite reran. Feature 028 – IDE Warning Remediation closed 2025-10-30. Feature 039 replay scope is reopened despite earlier closure; prior documentation sweep (T3909) remains the last completed increment before T3910 red tests begin.
- Quality gate note: `./gradlew --no-daemon :application:test :cli:test :rest-api:test :ui:test pmdMain pmdTest spotlessApply check` completed successfully on 2025-11-02 as part of Feature 039 T3909.
...
|------------|--------|----------------|----------------|-------|
| Feature 039 – EMV/CAP Simulation Services | In progress | T3909 (Documentation & quality gate) | T3910 – Replay scaffolding & red tests | Replay parity added to scope 2025-11-02; spec/plan/tasks updated, replay increments pending red tests before implementation (T3911–T3914) and documentation sweep (T3915). |
