...
7. Check [docs/4-architecture/open-questions.md](docs/4-architecture/open-questions.md) for unresolved questions.
8. Consult [docs/_current-session.md](docs/_current-session.md) for the latest workstream snapshot; update it as you discover new status.
...
- Once direction is confirmed, ensure the analysis gate ([docs/5-operations/analysis-gate-checklist.md](docs/5-operations/analysis-gate-checklist.md)) is satisfied, then proceed with planning/implementation per [AGENTS.md](AGENTS.md) guidelines.

## Handoff Prompt Template
Copy/paste the template in [docs/5-operations/session-quick-reference.md](docs/5-operations/session-quick-reference.md) when opening a new chat so the next agent inherits the full context quickly. Replace bracketed sections with the current details.
