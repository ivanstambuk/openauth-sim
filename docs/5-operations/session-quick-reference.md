...
- [ ] Facade changes: consult [docs/4-architecture/facade-contract-playbook.md](docs/4-architecture/facade-contract-playbook.md) for cross-facade conventions and enforcement gates.
