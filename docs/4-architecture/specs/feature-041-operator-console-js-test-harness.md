...
4. Document harness usage inside `docs/4-architecture/specs/feature-041...` and mirror the guidance in the feature plan/tasks so downstream contributors follow the same patterns.
...
4. Track coverage for any new protocol introduced after this spec by updating the checklist in `docs/4-architecture/tasks/feature-041-operator-console-js-test-harness.md` before merging.
