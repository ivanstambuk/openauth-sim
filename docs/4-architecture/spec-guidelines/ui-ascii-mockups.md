...
> Use this guide together with the spec template at [docs/templates/feature-spec-template.md](docs/templates/feature-spec-template.md); fill the template’s “UI / Interaction Mock-ups” section using the practices below.
