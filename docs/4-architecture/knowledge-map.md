...
- HOTP evaluation now runs within the operator console (stored credential counters + inline requests), while TOTP, FIDO2/WebAuthn, EMV/CAP, and EUDI wallet packages (OpenID4VP 1.0, ISO/IEC 18013-5, SIOPv2) remain pending as placeholder tabs until their specs and facades land.
