...
- SpotBugs dead-state enforcement (Feature 015) adds a shared include filter so unread/unwritten field detectors fail `./gradlew check` uniformly across JVM modules.
