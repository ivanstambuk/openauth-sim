...
| 004 | FIDO2/WebAuthn Assertions & Attestations | In review | Combined assertion + attestation simulator with deterministic fixtures, trust-anchor handling, and operator guidance. | [spec](features/004/spec.md) · [plan](features/004/plan.md) · [tasks](features/004/tasks.md) |
