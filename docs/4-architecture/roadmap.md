...
| 5 | OCRA operator UI | Build an operator UI consuming the OCRA REST endpoint for manual operations | Not started | Spec: [Feature 006](specs/feature-006-ocra-operator-ui.md) drafted 2025-09-28; plan/tasks pending |
