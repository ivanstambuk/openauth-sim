...
| 4 | REST API (Spring Boot) | Expose emulator capabilities over REST with OpenAPI documentation | In progress | Feature 003 R004 wired `/api/v1/ocra/evaluate`, R005 published SpringDoc contract/operator how-to, and R006 wrap-up captured telemetry snapshot + spotless check (2025-09-28); depends on Workstreams 1 & 2 |
