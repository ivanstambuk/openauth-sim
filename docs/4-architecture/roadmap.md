...
| 4 | REST API (Spring Boot) | Expose emulator capabilities over REST with OpenAPI documentation | In planning | Feature 003 spec/plan (OCRA evaluation endpoint) drafted 2025-09-28; depends on Workstreams 1 & 2 |
