...
_Status:_ Complete  
_Last updated:_ 2025-11-05 (T2650 stored credential sanitisation complete) (S26-05)

☑ **T2601 – Fixture scaffolding**   (S26-01)
...
☑ **T2602 – Core attestation engine implementation**   (S26-01)
 ☑ Implement attestation helpers satisfying T2601 tests, including format-specific validation and error mapping.   (S26-01)
...
☑ **T2603 – Application services & telemetry**   (S26-02)
...
☑ **T2606 – Operator UI Evaluate toggle**   (S26-04)
...
☑ **T2607 – Operator UI Replay attestation support**   (S26-04)
...
☑ **T2608 – Fixture ingestion & documentation**   (S26-04)
...
☑ **T2609 – Trust anchor ingestion helpers**   (S26-04)
...
☑ **T2611 – Generator test scaffolding**   (S26-01)
...
☑ **T2612 – Core generator implementation**   (S26-01)
...
☑ **T2613 – Facade integration (CLI/REST)**   (S26-03)
...
☑ **T2614 – Operator UI Evaluate migration**   (S26-04)
...
☑ **T2615 – Checkstyle/PMD remediation**   (S26-02)
...
☑ **T2616 – Attestation result panel trim**   (S26-04)
...
☑ **T2617 – Attestation response payload reduction**   (S26-04)
...
☑ **T2623 – Credential ID alignment**   (S26-03)
...
☑ **T2625 – UI certificate chain count badge**   (S26-04)
 ☑ Reintroduce the attestation result certificate-chain count label (matching the pre-T2617 summary styling) while keeping the PEM block separate from the JSON payload.   (S26-04)
...
☑ **T2626 – UI attestation result layout**   (S26-04)
...
☑ **T2627 – Certificate heading styling**   (S26-04)
...
☑ **T2629 – Assertion payload sanitization**   (S26-03)
...
☑ **T2628 – Attestation private key format parity**   (S26-04)
...
☑ **T2618 – Core Manual input source**   (S26-02)
...
☑ **T2619 – Application service Manual wiring**   (S26-02)
...
☑ **T2620 – REST inputSource + conditional validation**   (S26-03)
...
☑ **T2621 – UI auto-switch + Manual mode**   (S26-04)
...
☑ **T2622 – CLI parity for Manual**   (S26-03)
...
☑ **T2630 – Attestation preset label harmonisation**   (S26-04)
...
☑ **T2631 – Credential store attestation schema**   (S26-05)
...
☑ **T2632 – Stored attestation generation services**   (S26-05)
...
☑ **T2633 – CLI/REST stored flow support**   (S26-03)
...
☑ **T2634 – Operator UI stored selector**   (S26-04)
...
☑ **T2635 – Seed stored attestation credentials**   (S26-05)
...
☑ **T2636 – Stored attestation replay test scaffolding**   (S26-05)
...
☑ **T2637 – Stored attestation replay implementation**   (S26-05)
	☑ Implement REST `inputSource=STORED` replay handling (DTO validation, service/controller branches), CLI flag plumbing, and telemetry enrichment mirroring stored generation reason codes.  
		...
		- UI: align with stored replay toggle (covered under T2638) but ensure API responds with stored challenge/clientData/attestationObject to hydrate Selenium expectations.   (S26-04)
	☑ Drive T2636 tests green, refresh OpenAPI snapshots, and document any new reason codes.   (S26-05)
...
☑ **T2638 – Operator UI stored replay & identifier removal**   (S26-04)
...
☑ **T2639 – Documentation & telemetry sync**   (S26-05)
...
☑ **T2640 – Attestation replay sample loader parity**   (S26-04)
...
☑ **T2641 – Stored replay payload display**   (S26-04)
...
☑ **T2642 – Stored replay challenge hydration fix**   (S26-04)
...
☑ **T2643 – Stored attestation label normalization**   (S26-04)
...
☑ **T2644 – Unified stored credential seeding**   (S26-05)
...
☑ **T2645 – Synthetic PS256 attestation fixture**   (S26-05)
...
☑ **T2646 – Stored replay dropdown stabilisation**   (S26-04)
...
☑ **T2647 – Stored replay read-only styling parity**   (S26-04)
...
☑ **T2648 – Curated trust anchor selector**   (S26-04)
...
☑ **T2649 – Stored replay trust-anchor summary**   (S26-05)
...
- [x] **T2650 – Stored credential secret sanitisation**   (S26-05)
...
- 2025-11-05 – Sanitisation follow-up (T2650) completed; owner to confirm re-closure post-review. (S26-05)
