...
| S29-04 | Remediate domain-layer violations (core modules) surfaced by the new rules. |
| S29-05 | Remediate service/facade violations across application/infra/CLI/REST/UI, adding justified excludes only when necessary. |
| S29-06 | Update documentation/runbooks and re-run spotless/PMD gates to close the feature. |
