...
## Objective
Apply targeted Java 17 features across the CLI and REST OCRA modules to improve compile-time guarantees and documentation clarity without altering external contracts. Reference specification: `docs/4-architecture/features/013/spec.md`.
...
- R1302 – Update `docs/4-architecture/features/013/tasks.md` with ≤30 minute increments.
