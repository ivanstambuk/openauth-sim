...
44. **I44 – Stored replay trust-anchor summary**  
    - Update spec/plan/tasks to capture the read-only anchor summary requirement so documentation leads the implementation.  
