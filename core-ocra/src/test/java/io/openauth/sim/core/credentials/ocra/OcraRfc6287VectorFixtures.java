...
final class OcraRfc6287VectorFixtures {
    ...
    static final String STANDARD_KEY_20 =
            uppercaseSecret(OcraJsonVectorFixtures.getOneWay("rfc6287_standard-challenge-question-numeric-q"));
    ...
    static final String STANDARD_KEY_64 =
            uppercaseSecret(OcraJsonVectorFixtures.getOneWay("rfc6287_counter-only-sha512-question-00000000"));
    static final String SESSION_HEX_64 = sessionOf("rfc6287_session-information-s064-with-alphanumeric-challenge");
    static final String SESSION_HEX_128 = sessionOf("rfc6287_session-information-s128-with-alphanumeric-challenge");
    static final String SESSION_HEX_256 = sessionOf("rfc6287_session-information-s256-with-alphanumeric-challenge");
    static final String SESSION_HEX_512 = sessionOf("rfc6287_session-information-s512-with-alphanumeric-challenge");
    static final String PIN_SHA1_HASH = OcraJsonVectorFixtures.getOneWay("rfc6287_counter-with-hashed-pin-c-0")
            .pinHashHex()
    ...
    private static List<OneWayVector> oneWayBySuite(String suite, Comparator<OcraOneWayVector> comparator) {
        return OcraJsonVectorFixtures.loadOneWayVectors()
    ...
    private static String sessionOf(String vectorId) {
        return OcraJsonVectorFixtures.getOneWay(vectorId)
                ...
                .orElseThrow(() -> new IllegalStateException("Vector " + vectorId + " missing session info"));
    }
