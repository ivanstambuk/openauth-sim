...
final class OcraCredentialDescriptorTest {
    ...
    void descriptorRejectsBlankNames() {
        ...
        IllegalArgumentException exception = assertThrows(
                ...
                () -> new OcraCredentialDescriptor(
                        "   ", suite, DEFAULT_SECRET, Optional.empty(), Optional.empty(), Optional.empty(), Map.of()));
    ...
    void requestCopiesMetadata() {
        ...
        OcraCredentialRequest request = new OcraCredentialRequest(
                "credential-a", DEFAULT_SUITE, DEFAULT_SECRET.asHex(), SecretEncoding.HEX, null, null, null, metadata);
    ...
    void requestDefaultsNullMetadataToEmptyMap() {
        OcraCredentialRequest request = new OcraCredentialRequest(
                "credential-b", DEFAULT_SUITE, DEFAULT_SECRET.asHex(), SecretEncoding.HEX, null, null, null, null);
    ...
    void descriptorFactoryNormalisesInputs() {
        ...
        IllegalArgumentException counterNotPermitted = assertThrows(
                IllegalArgumentException.class,
                () -> factory.create("counter-not-allowed", DEFAULT_SUITE, DEFAULT_SECRET, 1L, null, null, Map.of()));
    ...
    void descriptorFactoryValidatesPinRequirements() {
        ...
        IllegalArgumentException pinRequired = assertThrows(
                IllegalArgumentException.class,
                () -> factory.create(
                        "pin-required", "OCRA-1:HOTP-SHA1-6:C-QN08-PSHA1", DEFAULT_SECRET, 1L, null, null, Map.of()));
        assertTrue(pinRequired.getMessage().contains("pinHash required"));

        IllegalArgumentException pinNotPermitted = assertThrows(
                IllegalArgumentException.class,
                () -> factory.create(
                        "pin-not-permitted",
                        DEFAULT_SUITE,
        ...
        IllegalArgumentException invalidLength = assertThrows(
                IllegalArgumentException.class,
                () -> factory.create(
                        "pin-invalid-length",
    ...
    void descriptorFactoryValidatesDriftWindow() {
        ...
        IllegalArgumentException invalidDrift = assertThrows(
                IllegalArgumentException.class,
                () -> factory.create(
                        "invalid-drift",
