...
class OcraPersistenceAdapterTest {
    ...
    void setUp() {
        ...
        adapter = new OcraCredentialPersistenceAdapter(new OcraCredentialDescriptorFactory(), fixedClock);
    }
    ...
    void serializeDescriptorProducesVersionedRecord() {
        ...
        assertEquals(descriptor.suite().value(), record.attributes().get(OcraCredentialPersistenceAdapter.ATTR_SUITE));
    ...
    void deserializeRecordRestoresDescriptor() {
        ...
        attributes.put(OcraCredentialPersistenceAdapter.ATTR_PIN_HASH, "5e884898da28047151d0e56f8dc6292773603d0d");
        attributes.put(
                OcraCredentialPersistenceAdapter.ATTR_ALLOWED_DRIFT_SECONDS,
                String.valueOf(Duration.ofSeconds(30).toSeconds()));
        attributes.put(OcraCredentialPersistenceAdapter.ATTR_METADATA_PREFIX + "environment", "staging");
        ...
        assertEquals(
                "5e884898da28047151d0e56f8dc6292773603d0d",
                descriptor.pinHash().orElseThrow().asHex());
    ...
    void deserializeRejectsMissingSuite() {
        ...
        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> adapter.deserialize(record));
    ...
    private OcraCredentialDescriptor descriptorWithMetadata() {
        OcraCredentialFactory.OcraCredentialRequest request = new OcraCredentialFactory.OcraCredentialRequest(
                "token-1",
