...
final class OcraResponseCalculatorEdgeCaseTest {
    ...
    void numericChallengeRequiresDigits() {
        ...
        OcraResponseCalculator.OcraExecutionContext context =
                new OcraResponseCalculator.OcraExecutionContext(null, "12AB5678", null, null, null, null, null);

        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> call(descriptor, context));
    ...
    void hexChallengeRequiresHexCharacters() {
        ...
        OcraResponseCalculator.OcraExecutionContext context =
                new OcraResponseCalculator.OcraExecutionContext(null, "G1234567", null, null, null, null, null);
    ...
    void concatenatesClientAndServerChallenges() {
        ...
        OcraResponseCalculator.OcraExecutionContext combinedQuestion =
                new OcraResponseCalculator.OcraExecutionContext(null, "ABCD1234", null, null, null, null, null);
        OcraResponseCalculator.OcraExecutionContext splitChallenges =
                new OcraResponseCalculator.OcraExecutionContext(null, null, null, "ABCD", "1234", null, null);
    ...
    void negativeCounterRejected() {
        ...
        OcraResponseCalculator.OcraExecutionContext context =
                new OcraResponseCalculator.OcraExecutionContext(-1L, "12345678", null, null, null, null, null);
    ...
    void blankTimestampRejected() {
        OcraCredentialDescriptor descriptor = descriptor("OCRA-1:HOTP-SHA1-6:QA08-T1", null, null);
        OcraResponseCalculator.OcraExecutionContext context =
                new OcraResponseCalculator.OcraExecutionContext(null, "12345678", null, null, null, null, "   ");
    ...
    void timestampOddLengthNormalized() {
        ...
        OcraResponseCalculator.OcraExecutionContext oddLength =
                new OcraResponseCalculator.OcraExecutionContext(null, "12345678", null, null, null, null, "123");
        OcraResponseCalculator.OcraExecutionContext padded =
                new OcraResponseCalculator.OcraExecutionContext(null, "12345678", null, null, null, null, "0123");
    ...
    void sessionInformationIsLeftPadded() {
        ...
        OcraResponseCalculator.OcraExecutionContext shortContext =
                new OcraResponseCalculator.OcraExecutionContext(null, "12345678", shortSession, null, null, null, null);
        OcraResponseCalculator.OcraExecutionContext paddedContext = new OcraResponseCalculator.OcraExecutionContext(
    ...
    void sessionTokenVariantsPadToDeclaredLength(String token, int lengthBytes) {
        OcraCredentialDescriptor descriptor = descriptor("OCRA-1:HOTP-SHA1-6:QA08-" + token, null, null);
    ...
    void sessionInformationTooLongRejected() {
        ...
        OcraResponseCalculator.OcraExecutionContext context =
                new OcraResponseCalculator.OcraExecutionContext(null, "12345678", tooLong, null, null, null, null);
    ...
    void storedPinHashUsedWhenPresent() {
        ...
        OcraCredentialDescriptor descriptor = descriptor("OCRA-1:HOTP-SHA1-6:QA08-PSHA1", null, pinHash);
        ...
        OcraResponseCalculator.OcraExecutionContext runtimePin =
                new OcraResponseCalculator.OcraExecutionContext(null, "12345678", null, null, null, pinHash, null);
    ...
    void pinHashRuntimeNormalizedSha1() {
        ...
        OcraResponseCalculator.OcraExecutionContext shortContext =
                new OcraResponseCalculator.OcraExecutionContext(null, "12345678", null, null, null, shortPin, null);
        OcraResponseCalculator.OcraExecutionContext paddedContext =
                new OcraResponseCalculator.OcraExecutionContext(null, "12345678", null, null, null, paddedPin, null);
    ...
    private static OcraCredentialDescriptor descriptor(String suite, Long counter, String pinHashHex) {
