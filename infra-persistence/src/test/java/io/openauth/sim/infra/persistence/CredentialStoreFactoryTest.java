...
final class CredentialStoreFactoryTest {
  ...
  @Test
  @DisplayName("resolveDatabasePath falls back to default file")
  void resolveDatabasePathFallsBackToDefault() {
    Path resolved = CredentialStoreFactory.resolveDatabasePath("   ", "fallback.db");
    assertTrue(resolved.toString().endsWith("fallback.db"));
  }
